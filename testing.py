...
class Tilemap:
    ...
    def render(self, surf, scroll_offset):
        for loc in self.tilemap:
            ...
            x_pos = tile['pos'][0] * self.tile_size
            y_pos = tile['pos'][1] * self.tile_size
...
def createGame():
    def redrawGameWindow():
        ...
        timer_surface = font.render(timer_text, True, (255, 255, 255))  # Use font here
    ...
    font = pygame.font.Font(None, 74)  # This should be initialized before using it
